...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2019 at 02:33 PM
...
(1, '2013_09_14_061027_create_divisions_table', 1),
(2, '2013_09_14_061048_create_districts_table', 1),
(3, '2013_09_14_061107_create_upazilas_table', 1),
(4, '2014_10_12_000000_create_users_table', 1),
(7, '2014_10_12_100000_create_password_resets_table', 2),
(9, '2019_09_11_145333_create_request_bloods_table', 3);
...
CREATE TABLE `request_bloods` (
  ...
  `when_need` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `request_bloods`
--

INSERT INTO `request_bloods` (`id`, `name`, `blood_group`, `mobile`, `division`, `district`, `upazila`, `when_need`, `created_at`, `updated_at`) VALUES
(1, 'Jane Smith', 'O-', '01712345678', 4, 63, 319, '2019-09-27', '2019-09-15 03:48:58', '2019-09-15 03:48:58');
...
CREATE TABLE `users` (
  ...
  `upazila` bigint(20) UNSIGNED NOT NULL,
  `mobile` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `last_donate_date` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `blood_group`, `division`, `district`, `upazila`, `mobile`, `last_donate_date`, `isAdmin`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Rudra Sarkar', 'rudra@mail.com', '$2y$10$f0UPSFH1vzpcXSxlJSJ4pu0KTEIwtIGL8S6ZlHEhSgfKUK/JXpUTa', 'B+', 5, 21, 357, '01716563467', '2019-09-02', NULL, 'Rcb1NUSVKVzz8Z43gzUvJbisaLAEe6jTk09bWaw7TpTNzZx1sW3b2B6S6m3y', '2019-09-14 01:18:23', '2019-09-15 00:41:17'),
(2, 'Rakib Hossain', 'rakib@mail.com', '$2y$10$FhcJDFNyONHF0EZUvpg4TO9y72kv8y8nQw3HSslS9ILhwqxYfWW1q', 'A+', 3, 11, 225, '01712345678', NULL, NULL, NULL, '2019-09-14 01:29:15', '2019-09-14 01:29:15'),
(3, 'John Doe', 'john@mail.com', '$2y$10$nxvwoKoptv5jBnMHGxwzkeVbyuvvz.4dNRtYHDqqNV0Eib8XJ2Bry', 'A+', 1, 36, 22, '01712345678', NULL, NULL, NULL, '2019-09-14 12:53:34', '2019-09-15 01:12:50'),
(4, 'Jack Smith', 'bpos@mail.com', '$2y$10$4onNkClu3vgNvvbmBNdzG.mDecD/ZAznH2eDttlBo.oIcEafI8mny', 'B+', 1, 36, 22, '01712345678', NULL, NULL, NULL, '2019-09-15 04:08:41', '2019-09-15 04:08:41');
...
ALTER TABLE `request_bloods`
  ADD PRIMARY KEY (`id`),
  ADD KEY `request_bloods_division_foreign` (`division`),
  ADD KEY `request_bloods_district_foreign` (`district`),
  ADD KEY `request_bloods_upazila_foreign` (`upazila`);
...
ALTER TABLE `users`
  ...
  ADD KEY `users_upazila_foreign` (`upazila`);
...
--
-- Constraints for table `request_bloods`
--
ALTER TABLE `request_bloods`
  ADD CONSTRAINT `request_bloods_district_foreign` FOREIGN KEY (`district`) REFERENCES `districts` (`id`),
  ADD CONSTRAINT `request_bloods_division_foreign` FOREIGN KEY (`division`) REFERENCES `divisions` (`id`),
  ADD CONSTRAINT `request_bloods_upazila_foreign` FOREIGN KEY (`upazila`) REFERENCES `upazilas` (`id`);
...
ALTER TABLE `users`
  ...
  ADD CONSTRAINT `users_division_foreign` FOREIGN KEY (`division`) REFERENCES `divisions` (`id`),
  ADD CONSTRAINT `users_upazila_foreign` FOREIGN KEY (`upazila`) REFERENCES `upazilas` (`id`);
COMMIT;
